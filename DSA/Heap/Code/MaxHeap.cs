...
class MaxHeap {
    ...
    static void Main() {
        Console.WriteLine("=== Max Heap (C#) ===\n");
        
        MaxHeap heap = new MaxHeap();
        
        Console.WriteLine("Inserting: 5, 10, 3, 2, 8, 1");
        heap.Insert(5);
        heap.Insert(10);
        heap.Insert(3);
        heap.Insert(2);
        ...
        Console.WriteLine("Extract: " + heap.ExtractMax());
        heap.PrintHeap();
        Console.WriteLine("Extract: " + heap.ExtractMax());
        heap.PrintHeap();
        ...
        Console.WriteLine("4. Maximum element always at root\n");
        
        Console.WriteLine("=== Max Heap Complexity ===");
        Console.WriteLine("Insert:      O(log n)");
        Console.WriteLine("Extract Max: O(log n)");
        Console.WriteLine("Get Max:     O(1)");
